...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[x=.98cm,y=1cm]
    ...
    \foreach \u/\v in {s1/s2,s2/s3,s3/s4,s4/s5}
      \draw[vis/edge] (\u) -- (\v);
    \draw[black!65,line width=.9pt] (-4.52,-2.82) -- (-2.75,-2.82)
      node[left,vis/label] {$v_0$};
    \draw[black!65,line width=.9pt,dashed] (-3.62,-3.16) -- (-2.75,-3.16)
      node[left,vis/label] {$v_1$};
    \draw[semblue,line width=1.2pt] (-2.72,-3.50) -- (-.98,-3.50)
      node[left,vis/label,text=semblue] {$v_2$};
    \draw[semblue,line width=1.2pt] (-4.52,-3.84) -- (-.98,-3.84)
      node[left,vis/label,text=semblue] {$acc$};
